...
| **Serve** | `@getmikk/mcp-server` | 37 MCP tools + 3 resources. Cache busted immediately after `mikk analyze`. ~5ms per call |
...
| `@getmikk/mcp-server` | 37 MCP tools + 3 resources, lock-file-mtime cache invalidation |
